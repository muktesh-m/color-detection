...
def main():
    ...
    if uploaded_file is not None:
        ...
        with col1:
            ...
            start_x = st.slider("", min_value=0, max_value=img_width - display_width, value=0, format="%d", step=1, key="horizontal_scroll", help="Scroll left/right", label_visibility="collapsed")

            # Vertical slider on the left
            st.write("### Vertical Scroll")
            start_y = st.slider("", min_value=0, max_value=img_height - display_height, value=0, format="%d", step=1, key="vertical_scroll", help="Scroll up/down", label_visibility="collapsed")
